...
<body>
    ...
    <div class="info-grid">
        <div class="info-block">
            <label>Tagihan Dari (Supplier)</label>
    ...
    <div style="display:flex; justify-content:flex-end;">
        <div style="width:280px;">
            <div class="total-section">
                ...
                <div class="total-row" style="color:#dc2626; font-weight:700;"><span>Sisa Hutang:</span><span>Rp {{ number_format($invoice->outstanding_amount, 0, ',', '.') }}</span></div>
            </div>
        </div>
    </div>
</body>
