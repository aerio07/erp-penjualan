...
@section('page-title', 'Laporan Hutang Usaha (AP Report)')
...
<div class="animate-in">
    <div class="page-header">
        <div>
            ...
            <p>Daftar invoice pembelian supplier yang belum lunas</p>
        </div>
    </div>

    <div class="grid grid-2" style="margin-bottom:24px;">
        <div class="stat-card">
            <div class="icon" style="background:#fee2e2; color:#991b1b;"><i class="fa-solid fa-file-invoice"></i></div>
            <div class="value">Rp {{ number_format($totalOutstanding, 0, ',', '.') }}</div>
            <div class="label">Total Hutang Beredar</div>
        </div>

        <div class="stat-card">
            <div class="icon" style="background:#fee2e2; color:#991b1b;"><i class="fa-solid fa-triangle-exclamation"></i></div>
            <div class="value" style="color:var(--danger);">Rp {{ number_format($overdue, 0, ',', '.') }}</div>
            <div class="label">Hutang Jatuh Tempo (Overdue)</div>
        </div>
    </div>
